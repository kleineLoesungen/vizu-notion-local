<template>
  <div class="bg-gray-50 border-l border-gray-200 p-4 w-64 overflow-y-auto" role="region" aria-label="Filters">
    <h2 class="font-semibold text-sm text-gray-900 mb-4">Filters &amp; Visibility</h2>
